...
in
{
  dix = super.dix or { } // {
    ...
    paperspace-cli = super.callPackage ./packages/bitwarden-cli { };
    pinentry-touchid = super.callPackage ./packages/pinentry-touchid { };
  } // super.lib.mapAttrs (name: { src, version, ... }: self.mkDerivationKeepSrc { inherit name src version; }) dix-packages;
}
